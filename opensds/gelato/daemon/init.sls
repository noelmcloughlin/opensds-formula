...
include:
  - s.gelato.config
        {%- if "keystone" in s.hotpot.sodafoundationconf.let.auth_strategy|lower %}
...
{{ workflow('sodafoundation', 'gelato daemon', id, s.gelato, s.dir.gelato, sodafoundation, golang) }}
