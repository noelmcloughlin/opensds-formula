...
### sodafoundationrc
sodafoundation config sodafoundationrc file generated:
  file.managed:
    - name: {{ sodafoundation.dir.hotpot }}/sodafoundationrc
    - source: salt://sodafoundation/files/sodafoundationrc.j2
    - makedirs: True
    - template: jinja
    - user: {{ sodafoundation.user or 'root' }}
    - mode: {{ sodafoundation.file_mode or '0644' }}
...
sodafoundation infra system profile present:
  file.managed:
    ...
    - context:
      ...
      sodafoundationhome: {{ sodafoundation.dir.hotpot }}
